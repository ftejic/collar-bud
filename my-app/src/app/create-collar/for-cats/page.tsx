...
const products = [
  { name: "Cat collar 1", price: 35, image: "/images/gallery/1.jpeg" },
  { name: "Cat collar 2", price: 40, image: "/images/gallery/1.jpeg" },
  { name: "Cat collar 3", price: 40, image: "/images/gallery/1.jpeg" },
];
